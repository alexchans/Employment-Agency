...
function StaffRER() {
    ...
    useEffect(() => {
        const fetchUsernames = async () => {
            const response = await axios.get(`http://172.24.240.1:8080/api/employerRequests/all`);
    ...
    const handleApprove = async (username) => {
        await axios.post(`http://172.24.240.1:8080/api/employer/create/${username}`);
        window.location.reload();
    };

    const handleDeny = async (username) => {
        await axios.put(`http://172.24.240.1:8080/api/employer/deleteRequest/${username}`);
        window.location.reload();
    };
        ...
        <div>
            ...
            <Dialog open={openDialog} onClose={handleCloseDialog}>
                ...
                <DialogContent>
                    ...
                    <p>Company: {PDetail.companyName}</p>
